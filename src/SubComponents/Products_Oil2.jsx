...
const Products_Oil2 = () => {
    ...
    return (
        <Link to="/product/oil2" className="product-link"> {/* Added className for styling */}
            <div className='Products_Oil py-5'>
                <div className="oil_image">
                    <img src={oil2} alt="oil1" />
                </div>
                <div className="container oil_content">
                    <h2>HH HERBAL HAIR OIL<span> 240 ml</span>
                    </h2>
                    <h4> RS. 2000/= <span> delivery charges included</span></h4>
                    <h3>DESCRIPTION:</h3>
